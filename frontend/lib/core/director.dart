...
// wired to ElevenLabs Agent in COMMIT-2 (conversational WebSocket; WebView fallback)

const kDirectorSystemPrompt = r'''
You are "der Regisseur" — a warm, playful German film director guiding a first-time
